...
return array(
    ...
    'routes' => array(
        ...
        //统计公众店铺商品的数量
        'item.topdcount' => ['uses' => 'sysitem_api_item_topdcount@itemCount', 'version'=>['v1']],
        ...
        //获取用户领取的恒大微购物VIP折扣卡信息
        'user.hdvip.get' => ['uses' => 'sysuser_api_hdvipGet@couponGet', 'version' => ['v1']],
        //获取恒大微购VIP折扣卡列表
        'user.hdvip.list' => ['uses' => 'sysuser_api_hdvipList@couponList', 'version' => ['v1']],
        // 取消订单返还优惠券
...
//      'user.check' => ['uses' => 'sysuser_api_user_account_check@check', 'version' => ['v1']],
        ...
        //获取公众店铺通知一条数据
        'topd.get.shopnoticeinfo' => ['uses' => 'topd_api_shop_getNoticeInfo@getNoticeInfo', 'version' => ['v1']],
        //获取公众店铺通知数据列表
        'topd.get.shopnoticelist' => ['uses' => 'topd_api_shop_getNoticeList@getNoticeList', 'version' => ['v1']],
        //保存店铺通知
        'topd.savenotice' => ['uses' => 'topd_api_shop_saveNotice@saveNotice', 'version' => ['v1']],
	...
	//恒大折扣卡接口
        'promotion.hdvip.verify' => ['uses' => 'syspromotion_api_hdvip_verify@couponUse', 'version' => ['v1']],
        ...
        //订单支付请求支付网关 公众店铺支付 Ric
        'payment.trade.topdpay' => ['uses' => 'ectools_api_payment_pay@topddoPay', 'version' => ['v1']],
        //退款单创建
        ...
        //代理商后台，分销商统计会员信息
        'agent.data.get' => ['uses' => 'agent_api_getData@getData', 'version' => ['v1']],
        //获取商家统计时间
        ...
        //获取公众店铺图片列表
        'image.topd.list' => ['uses' => 'image_api_topd_list@get', 'version'=>['v1']],
         //修改图片名称
