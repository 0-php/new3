...
class topc_ctl_member extends topc_controller {
    ...
    public function index()
    {
        ...
        $tradeParams['fields'] = 'hdvip_fee,tid,shop_id,user_id,status,payment,total_fee,post_fee,payed_fee,receiver_name,created_time,receiver_mobile,discount_fee,need_invoice,adjust_fee,order.title,order.price,order.num,order.pic_path,order.tid,order.oid,order.item_id,activity';
