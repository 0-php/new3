...
class sysshop_ctl_admin_shop extends desktop_controller{
    ...
    public function ajaxarea(){
        $postdata = input::get();
        $area = area::getChildrenById($postdata['area']);
    ...
    public function addSelfShop()
    {
        ...
        $pagedata['area'] =  area::getSheng();//获取省份
    ...
    public function saveSelfShop()
    {
        ...
        $postdata['area'] = area::getSelectArea($postdata['area']) . ":" . str_replace(",","/", $postdata['area']);
        $objShop = kernel::single('sysshop_data_shop');
        try
        {
    ...
    public function updateShopInfo($sellerId,$shopId)
    {
        ...
        $pagedata['area'] =  area::getSheng(); //获取省份
        $pagedata['shop']['area'] = area::getSelectArea(str_replace("/",",", $pagedata['shop']['area'])) . ":" . str_replace(",","/", $pagedata['shop']['area']);
    ...
    private function _getShop($data)
    {
        ...
        $shop['area'] = area::getSelectArea($data['shop']['area']) . ":" . str_replace(",","/", $data['shop']['area']);
        return $shop;
    }
