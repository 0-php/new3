...
class  syshdtj_ctl_admin_concert extends desktop_controller{

	public function index()
	{
        return $this->finder('syshdtj_mdl_concert',array(
            'title' => app::get('syshdtj')->_('代理商结算'),
    ...
    {
        $mdl_aftersales = app::get('syshdtj')->model('concert');
        $sub_menu = array(
