...
class pam_auth_user
{
    ...
    protected function syncCookieWithUserName($loginName = '')
    {
        ...
        {
            $expire = time() + 3600;//过期时间和session保持一致
        }
    ...
    {
        $this->attemptAemember = $remember;
        return $this;
    }

    public function getAttemptRemember()
    {
        return $this->attemptAemember;
    }
    ...
    public function login($userId, $loginName = null)
    {
        ...
        $this->pamAccount->setSession($userId, $loginName, $this->getAttemptRemember());
