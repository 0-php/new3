...
class image_ctl_admin_manage extends desktop_controller
{
    ...
    public function _views()
    {
        ...
        $sub_menu = array(
            ...
            2=>array('label'=>app::get('image')->_('店铺图片'),'optional'=>false,'filter'=>array('target_type'=>['shop','seller'],'disabled'=>0)),
            3=>array('label'=>app::get('image')->_('用户图片'),'optional'=>false,'filter'=>array('target_type'=>'user','disabled'=>0)),
            4=>array('label'=>app::get('image')->_('回收站'),'optional'=>false,'filter'=>array('disabled'=>1)),
        );
        return $sub_menu;
    }
