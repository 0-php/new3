<?php
class agent_ctl_orderIncome extends agent_controller
{
		...
		//详细交易数据
			...
			//近30天	
	 			 ...
	 			 /*分页*/
	 			  ...
	 			  $filter['pages'] = time();
	 			  $pagers = array(
	 			  	'link'=>url::action('agent_ctl_orderIncome@index',$filter),
	 			...
	 			*/
	 			...
	 			//业务报表分页
            		...
            		'token'=>time(),
	 				...
	 				return $this->page('agent/orderIncome.html', $pagedata);
	 			}
